				...
				<div class="cartPInfo" id="danjian-0-229363">
					<div class="clearit">
						...
						<div class="pItem pSubtotal">
							<span id="total_price" class="totalprice" qaq="${cart.id}">¥<fmt:formatNumber groupingUsed="false" value="${cart.price / 100 * cart.num}" maxFractionDigits="2" minFractionDigits="2"/></span>
						</div>
